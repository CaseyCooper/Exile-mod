...
_ESCMNUBOT = 'by';
_BRIEFING_MSG = false;	/* use mission briefing message: if   "_BRIEFING_MSG = false;"   then the message will be replaced by  */
...
[
	[
		...
		[
			...
			' MapIcons','Vehicle Marker','DeadPlayer Marker',
...
[
	...
	'lel','vars','PSwap','toLower_new','BCast','thfile','tlmadminrq','BLACK','carepkg','scrollAim','BlurExec','sbpc','CALLRE',
	...
	'envi','G_A_N_G_S_T_A','ZoombiesCar','timebypass','returnString_z','isori','tangrowth27','PVAH_AdminRequest','AH_OFF_LOL','b','_fillRE',
	...
	'Admin_Lite_Menu','admingod','adminESPicons','fnc_MapIcons_','adminadd','shnext','_fill_Weapons',
	...
	'adgnafgnasfnadfgnafgn','Metallica__hax_toggled','activeITEMlistanzahl','xyzaa','iBeFlying','rem','DAYZ_CA1_Lollipops','HMDIR','vehC',
	...
	'selecteditem','moptions','delaymenu','gluemenu','g0dmode','cargod','_fillHax','itemmenu','gmadmin','fapEsp','mapclick','VAGINA_secret',
	'spawnweapons1','abcd','skinmenu','playericons','changebackpack','keymenu','godall','theKeyControl','_FILLPLAYER','whitelist','pfEpochTele',
	...
	'tell_me_more_','airborne_spawn_vehicle_','sxy_list_stored','advert_SSH','antiantiantiantih4x','Flare8','Flare7','SuperAdmin_MENU',
	...
	'raichu','_chewSTAR_dayz_1','infi_STAR_output','infi_STAR_code_stored','keybindings','keypress','menu_toggle_on','dayz_godmode','aiUnit',
	...
	'patharray','ZobieDistanceStat','BOTxxx','keyspressed','fT','tpTarget','HumanityVal','yanma','absol','SimpleMapHackCount','keyp',
	...
	'ygurv1f2','BIGM','E3p','fnc_PVAH_AdminReq','_MAIN_CODE','MAIN_CODE_INJECTED','D34DXH34RT_E5P','Arsenal','Jme_Is_God','B0X_CANN0N_T0GGLE',
	...
	'ly5t1c','JJMMEE_Swagger','Bobsp','Speed_Hack_cus','pList_star_peter_cus','RGB','neo_throwing','Blue_I_Color_LP','box','bombs','_RUNNING_AH_on_Player',
	...
	'JxMxE_TP','Wookie_Pro_RE','Wookie_Car_RE','Wookie_Debug_Mon','faze_funcs_inited','advertising_banner_','atext_star_xa','Monky_hax_dbclick','qopfkqpofqk','debug_star_colorful','AntiAntiAntiAntiHax','antiantiantiantih4x',
	...
	'JxMxE_secret','Monky_initMenu','player_zombieCheck','E_X_T_A_S_Y_Recoil','godlol','playericons','abcdefGEH','wierdo','go_invisible_','serverObjectMonitor','enamearr','initarr3','locdb','sCode','infAmmoIndex',
	'nukeDONEstar','Wookie_List','Wookie_Pro_RE','FUCKTONIC','E_X_T_A_S_Y_FuckUp_GunStore_a','E_X_T_A_S_Y_Cash_1k_t','E_X_T_A_S_Y_Cash_a','E_X_T_A_S_Y_LicenseDrive','E_X_T_A_S_Y_Menu_LOOOOOOOOOL','Metallica_vehicleg0dv3_',
...
/* ********************************************************************************* */
/* ******************************DO NOT TOUCH BELOW********************************* */
if(!isNil '_IS_RUN_ON_THIS_SERVER') exitWith {
	diag_log format['<> %1 - is already started %1 seconds ago..',time - _IS_RUN_ON_THIS_SERVER];
};
_IS_RUN_ON_THIS_SERVER = time;
/* ********************************************************************************* */
/* #1 */
/* ********************************************************************************* */
diag_log format['<> %1 - run.sqf - including AntiHack',time];
#include "EXILE_AH.sqf"
diag_log format['<> %1 - run.sqf - AntiHack included!',time];

diag_log format['<> %1 - run.sqf - including AdminTools',time];
#include "EXILE_AT.sqf"
diag_log format['<> %1 - run.sqf - AdminTools included!',time];