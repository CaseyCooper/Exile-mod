...
//_cnt = 0;
{
	...
	s_player_guardToggle = _x addaction [format[("<t color=""#FFFFFF"">" + ("%1Toggle Guards to Kill all non-base owners | Default: On") +"</t>"),""],"dayz_code\actions\toggle_base_guards.sqf",_x,1,false,true,"",""];
