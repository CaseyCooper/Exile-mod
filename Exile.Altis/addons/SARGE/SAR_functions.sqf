...
SAR_commentator = {
    ...
    _speaker = _group createunit ["C_man_polo_6_F_afro", [(_unitpos select 0) , _unitpos select 1, 0], [], 0.5, "NONE"];
...
SAR_debug_array = {
    ...
    diag_log " ";
    diag_log format["Sarge's AI System: Array contents of %1 --------",_name];
    diag_log " ";
    ...
    diag_log " ";
    diag_log "Sarge's AI System: Array contents ----------- end   ----------";
    diag_log " ";
};
...
private ["_unit","_weapons","_weapon","_items","_unit_magazine_name","_item","_tool","_tools","_forEachIndex"];
	...
	removeGoggles _unit;
	if ((typeOf _unit) in SAR_leader_band_list) then {removeHeadgear _unit;sleep 1;_unit addHeadGear "H_Shemag_olive";};
	removeVest _unit;
