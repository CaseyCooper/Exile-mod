...
/* _cond="(side _this == resistance) && (side _target == east) && ('Exile_Item_InstaDoc' in magazines _this)";

//[nil,_leader,rADDACTION,"Give me a blood transfusion!", "addons\SARGE\SAR_interact.sqf","",1,true,true,"",_cond] call RE;

_leader addAction ["<t color=""#FF9500"">" + ("ARGH!") +"</t>"), "addons\SARGE\SAR_interact.sqf","",1,true,true,"",_cond]; */
